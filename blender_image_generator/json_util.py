...
def restore_img(m_train, t_num, raw_trains, train_vis, base_scene):
    """
    ...
    for car in cars:
        ...
        if car.get_blender_roof() != 'none' and train_vis != 'SimpleObjects':
...
def restore_depth_map(t_num, o_file, raw_trains, train_vis, base_scene):
    """
    ...
    :param:  base_scene (string)    : Michalski train scene
    """
    path = f'tmp/depth/{raw_trains}/{train_vis}/{base_scene}/t_{t_num}_depth'
