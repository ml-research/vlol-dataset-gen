...
eastbound(A) :-
   has_car(A,B), braced_wall(B), has_car(A,C).
eastbound(A) :-
   has_car(A,B), braced_wall(B), has_car(A,C).
eastbound(A) :-
   has_car(A,B), car_color(B,green), short(B).
eastbound(A) :-
   has_car(A,B), car_color(B,green), has_wheel0(B,2).
eastbound(A) :-
   has_car(A,B), car_color(B,green), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), car_color(B,green), solid_wall(B).
eastbound(A) :-
   has_car(A,B), car_color(B,green), has_car(A,C).
eastbound(A) :-
   has_car(A,B), car_color(B,green), has_car(A,C).
eastbound(A) :-
   has_car(A,B), car_color(B,green), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_payload(B,golden_vase), car_color(B,yellow).
eastbound(A) :-
   has_car(A,B), has_payload(B,golden_vase), short(B).
eastbound(A) :-
   has_car(A,B), has_payload(B,golden_vase), has_wheel0(B,2).
eastbound(A) :-
   has_car(A,B), has_payload(B,golden_vase), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), has_payload(B,golden_vase), braced_wall(B).
eastbound(A) :-
   has_car(A,B), has_payload(B,golden_vase), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_payload(B,golden_vase), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_payload(B,box), car_color(B,yellow).
eastbound(A) :-
   has_car(A,B), has_payload(B,box), short(B).
eastbound(A) :-
   has_car(A,B), has_payload(B,box), has_wheel0(B,2).
eastbound(A) :-
   has_car(A,B), has_payload(B,box), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), has_payload(B,box), solid_wall(B).
eastbound(A) :-
   has_car(A,B), has_payload(B,box), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_payload(B,barrel), car_color(B,green).
eastbound(A) :-
   has_car(A,B), has_payload(B,barrel), short(B).
eastbound(A) :-
   has_car(A,B), has_payload(B,barrel), has_wheel0(B,2).
eastbound(A) :-
   has_car(A,B), has_payload(B,barrel), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), has_payload(B,barrel), solid_wall(B).
eastbound(A) :-
   has_car(A,B), has_payload(B,barrel), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_payload(B,barrel), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_payload(B,barrel), has_car(A,C).
eastbound(A) :-
   has_car(A,B), car_color(B,yellow), short(B).
eastbound(A) :-
   has_car(A,B), car_color(B,yellow), has_wheel0(B,2).
eastbound(A) :-
   has_car(A,B), car_color(B,yellow), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), car_color(B,yellow), braced_wall(B).
eastbound(A) :-
   has_car(A,B), car_color(B,yellow), has_car(A,C).
eastbound(A) :-
   has_car(A,B), car_color(B,yellow), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_roof0(B,none), solid_wall(B).
eastbound(A) :-
   has_car(A,B), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_roof0(B,none), braced_wall(B).
eastbound(A) :-
   has_car(A,B), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   has_car(A,B), short(B), has_wheel0(B,2).
eastbound(A) :-
   has_car(A,B), short(B), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), short(B), solid_wall(B).
eastbound(A) :-
...
eastbound(A) :-
   has_car(A,B), short(B), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), short(B), braced_wall(B).
eastbound(A) :-
   has_car(A,B), short(B), has_car(A,C).
eastbound(A) :-
   has_car(A,B), short(B), has_car(A,C).
eastbound(A) :-
   has_car(A,B), solid_wall(B), has_car(A,C).
eastbound(A) :-
   has_car(A,B), solid_wall(B), has_car(A,C).
eastbound(A) :-
   has_car(A,B), solid_wall(B), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), solid_wall(B).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), has_roof0(B,none).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), braced_wall(B).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   has_car(A,B), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), car_color(B,green).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), short(B).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), has_wheel0(B,2).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), has_roof0(B,none).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), solid_wall(B).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_payload(B,barrel), has_car(A,C).
eastbound(A) :-
   car_num(B,1), car_color(B,green), short(B).
eastbound(A) :-
   car_num(B,1), car_color(B,green), has_wheel0(B,2).
eastbound(A) :-
   car_num(B,1), car_color(B,green), has_roof0(B,none).
eastbound(A) :-
   car_num(B,1), car_color(B,green), solid_wall(B).
eastbound(A) :-
   car_num(B,1), car_color(B,green), has_car(A,C).
eastbound(A) :-
   car_num(B,1), car_color(B,green), has_car(A,C).
eastbound(A) :-
   car_num(B,1), car_color(B,green), has_car(A,C).
eastbound(A) :-
   car_num(B,1), car_color(B,green), has_car(A,C).
eastbound(A) :-
   car_num(B,1), short(B), has_wheel0(B,2).
eastbound(A) :-
   car_num(B,1), short(B), has_roof0(B,none).
eastbound(A) :-
   car_num(B,1), short(B), solid_wall(B).
eastbound(A) :-
   car_num(B,1), short(B), has_car(A,C).
eastbound(A) :-
   car_num(B,1), short(B), has_car(A,C).
eastbound(A) :-
   car_num(B,1), short(B), has_car(A,C).
eastbound(A) :-
   car_num(B,1), short(B), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_wheel0(B,2), has_roof0(B,none).
eastbound(A) :-
   car_num(B,1), has_wheel0(B,2), solid_wall(B).
eastbound(A) :-
   car_num(B,1), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_wheel0(B,2), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_roof0(B,none), solid_wall(B).
eastbound(A) :-
   car_num(B,1), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_roof0(B,none), has_car(A,C).
eastbound(A) :-
   car_num(B,1), solid_wall(B), has_car(A,C).
eastbound(A) :-
   car_num(B,1), solid_wall(B), has_car(A,C).
eastbound(A) :-
   car_num(B,1), solid_wall(B), has_car(A,C).
eastbound(A) :-
   car_num(B,1), solid_wall(B), has_car(A,C).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_payload(C,barrel).
eastbound(A) :-
   car_num(B,1), has_car(A,C), car_color(C,green).
eastbound(A) :-
   car_num(B,1), has_car(A,C), short(C).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_wheel0(C,2).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_roof0(C,none).
eastbound(A) :-
   car_num(B,1), has_car(A,C), solid_wall(C).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_car(A,D).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_car(A,D).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_car(A,D).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_payload(C,golden_vase).
eastbound(A) :-
   car_num(B,1), has_car(A,C), car_color(C,yellow).
eastbound(A) :-
   car_num(B,1), has_car(A,C), short(C).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_wheel0(C,2).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_roof0(C,none).
eastbound(A) :-
   car_num(B,1), has_car(A,C), braced_wall(C).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_car(A,D).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_car(A,D).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_payload(C,box).
eastbound(A) :-
   car_num(B,1), has_car(A,C), car_color(C,yellow).
eastbound(A) :-
   car_num(B,1), has_car(A,C), short(C).
...
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_wheel0(C,2).
eastbound(A) :-
   car_num(B,1), has_car(A,C), has_roof0(C,solid_roof).
eastbound(A) :-
   car_num(B,1), has_car(A,C), solid_wall(C).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_payload(C,golden_vase).
eastbound(A) :-
   has_car(A,B), has_car(A,C), car_color(C,yellow).
eastbound(A) :-
   has_car(A,B), has_car(A,C), short(C).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_wheel0(C,2).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_roof0(C,none).
eastbound(A) :-
   has_car(A,B), has_car(A,C), braced_wall(C).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_car(A,D).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_car(A,D).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_payload(C,box).
eastbound(A) :-
   has_car(A,B), has_car(A,C), car_color(C,yellow).
eastbound(A) :-
   has_car(A,B), has_car(A,C), short(C).
...
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_roof0(C,none).
eastbound(A) :-
   has_car(A,B), has_car(A,C), solid_wall(C).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_car(A,D).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_payload(C,barrel).
eastbound(A) :-
   has_car(A,B), has_car(A,C), car_color(C,yellow).
eastbound(A) :-
   has_car(A,B), has_car(A,C), short(C).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_wheel0(C,2).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_roof0(C,solid_roof).
eastbound(A) :-
   has_car(A,B), has_car(A,C), solid_wall(C).
eastbound(A) :-
   has_car(A,B), has_car(A,C), has_payload(C,box).
